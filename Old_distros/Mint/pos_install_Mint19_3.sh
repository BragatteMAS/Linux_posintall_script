...
#Versão 1.0_Mint19.3_04/02/2020
...
## Others packages
sudo apt install libmuparser2v5 libqt5charts5 libqt5concurrent5 libqt5qml5 libqt5quick5 libqt5sql5 libqt5x11extras5 libqt5sql5-sqlite
sudo apt update -y
...
sudo apt install nemo-dropbox -y # for MINT distro - need second confirmation
...
##Instaling Flatpak packages ##sudo apt-add-repository "$PPA_Graphics_drivers" -y	# nvidia configsr
